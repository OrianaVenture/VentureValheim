...
Adds a new interconnected teleportation system! Travel Totems are added to new worlds as random locations to be discovered. Players can build Travel Totems to expand the network. Temporary Totem Bombs can be crafted or sold by merchants. Fully customize the behavior for your server!
