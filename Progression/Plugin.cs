...
namespace VentureValheim.Progression
{
    ...
    public class ProgressionPlugin : BaseUnityPlugin
    {
        ...
        public static ConfigEntry<bool> CE_AutoScaleCreatureIgnoreDefaults = null!;
        ...
        public void Awake()
        {
            ...
            AddConfig("AutoScaleCreaturesIgnoreDefaults", autoScaling,
                "When True ignores ALL default classifications assigned by the mod, use to keep vanilla values unless specifically overriden (boolean).",
                true, false, ref CE_AutoScaleCreatureIgnoreDefaults);
