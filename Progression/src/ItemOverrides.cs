...
namespace VentureValheim.Progression
{
    ...
    {
        private static string filePath = Paths.ConfigPath + Path.DirectorySeparatorChar + "WAP.ItemOverrides.yaml";
        ...
        public static ItemOverridesList ReadYaml()
        {
            ...
            {
                ProgressionPlugin.VentureProgressionLogger.LogWarning("No yaml file found, to use overrides the WAP.ItemOverrides.yaml file must be in your bepinex config folder.");
                return null;
            }
        }
