...
namespace VentureValheim.Progression
{
    ...
    {
        private static string filePath = Paths.ConfigPath + Path.DirectorySeparatorChar + "WAP.CreatureOverrides.yaml";
        ...
        public static CreatureOverridesList ReadYaml()
        {
            ...
            {
                ProgressionPlugin.VentureProgressionLogger.LogWarning("No yaml file found, to use overrides the WAP.CreatureOverrides.yaml file must be in your bepinex config folder.");
                return null;
            }
        }
